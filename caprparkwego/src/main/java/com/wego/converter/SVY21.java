...
public class SVY21 {
    ...
    /**
     * Computes Latitude and Longitude based on an com.wego.converter.SVY21 coordinate.
     *
     ...
     *
     * @param N Northing based on com.wego.converter.SVY21.
     * @param E Easting based on com.wego.converter.SVY21.
     * @return the conversion result a com.wego.converter.LatLonCoordinate.
     */
     ...
     * public com.wego.converter.LatLonCoordinate computeLatLon(double N, double E).
     *
     * @param coord an com.wego.converter.SVY21Coordinate object to convert.
     * @return the conversion result a com.wego.converter.LatLonCoordinate.
     */
    ...
    /**
     * Computes com.wego.converter.SVY21 Northing and Easting based on a Latitude and Longitude coordinate.
     *
     * This method returns an immutable com.wego.converter.SVY21Coordinate object that contains two fields,
     * northing, accessible with .getNorthing(), and
     * easting, accessible with .getEasting().
     *
     * @param lat latitude in degrees.
     * @param lon longitude in degrees.
     * @return the conversion result as an com.wego.converter.SVY21Coordinate.
     */
     ...
     *
     * This method is a shorthand for the functionally identical
     * public com.wego.converter.SVY21Coordinate computeSVY21(double lat, double lon).
     *
     * @param coord a com.wego.converter.LatLonCoordinate object to convert.
     * @return the conversion result an com.wego.converter.SVY21Coordinate.
     */
